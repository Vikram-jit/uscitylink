...
import 'package:chat_app/modules/home/widgets/user_add_form_dialog.dart';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ContainerHeader(
              ...
              onActionPressed: () {
                showDialog(
                  ...
                  builder: (_) => UserAddFormDialog(role: "staff"),
                );
              },
            ),
            ...
            Expanded(
              child: FutureBuilder(
                future: _driverController.getUser(page: 1, role: "driver"),
                builder: (context, snapshot) {
                  ...
                  return Obx(() {
                    final usres = _driverController.users.value;

                    return TableContainer<UserProfileModel>(
                      data: usres,

                      config: DataTableConfig<UserProfileModel>(
                        isScrollable: true,
                        title: "Drivers",
                        columns: [
                          DataColumn(
                              ...
                              DataCell(
                                SizedBox(
                                  ...
                                  child: Container(
                                    ...
                                    height: 10,
                                    child: CircleAvatar(
                                      backgroundColor: driver?.isOnline ?? false
                                          ? Colors.green
                                          : Colors.red,
                                    ),
                                  ),
                        ...
                        onPageChanged: (page) {
                          ...
                          _driverController.getUser(page: page, role: "driver");
                        },
