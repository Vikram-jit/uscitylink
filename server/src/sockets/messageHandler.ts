...
export async function driverMessageQueueProcessResend(
  io: Server,
  socket: CustomSocket,
  messageId: string,
  body: string,
  ...
  if (messageSave) {
    ...
    messageSave = await Message.create({
      channelId: channelId,
...
export async function driverMessageQueueProcess(
  ...
  const messageSave = await Message.create({
    ...
    messageDirection: "R",
    deliveryStatus: "sent",
    messageTimestampUtc: messageTimestampUtc || new Date(),
    senderId: socket?.user?.id,
    isRead: false,
    status: "sent",
    url: url,
...
export async function messageToDriverByForward(
  io: Server,
  socket: CustomSocket,
  userIds: string[],
  body: string,
...
export async function getMessageByTempId(
  io: Server,
  socket: CustomSocket,
  messageId: string,
  channelId: string
