...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1316: (x0,x1) => x0.send(x1),
      _1317: x0 => x0.abort(),
      _1318: x0 => x0.getAllResponseHeaders(),
      _1321: x0 => x0.close(),
      _1322: x0 => new WebSocket(x0),
      _1323: (x0,x1) => x0.send(x1),
      _1324: x0 => x0.decode(),
      ...
      _1335: (x0,x1) => x0.createMediaElementSource(x1),
      _1336: x0 => x0.createStereoPanner(),
      _1337: (x0,x1) => x0.connect(x1),
      _1338: (x0,x1) => x0.getItem(x1),
      _1339: (x0,x1) => x0.removeItem(x1),
      _1340: (x0,x1,x2) => x0.setItem(x1,x2),
      _1416: (x0,x1) => x0.appendChild(x1),
      _1418: () => globalThis.removeSplashFromWeb(),
      _1427: Date.now,
      _1429: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1430: s => {
      ...
      _1454: (o, p, r) => o.replaceAll(p, () => r),
      _1455: (o, p, r) => o.replace(p, () => r),
      _1456: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1457: s => s.toUpperCase(),
      _1458: s => s.trim(),
      _1459: s => s.trimLeft(),
      _1460: s => s.trimRight(),
      _1461: (string, times) => string.repeat(times),
      _1462: Function.prototype.call.bind(String.prototype.indexOf),
      _1463: (s, p, i) => s.lastIndexOf(p, i),
      _1464: (string, token) => string.split(token),
      _1465: Object.is,
      _1466: o => o instanceof Array,
      _1467: (a, i) => a.push(i),
      _1468: (a, i) => a.splice(i, 1)[0],
      _1471: a => a.pop(),
      _1472: (a, i) => a.splice(i, 1),
      _1473: (a, s) => a.join(s),
      _1474: (a, s, e) => a.slice(s, e),
      _1476: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1477: a => a.length,
      _1478: (a, l) => a.length = l,
      _1479: (a, i) => a[i],
      _1480: (a, i, v) => a[i] = v,
      _1482: o => {
      ...
      _1483: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1485: o => o instanceof Uint8Array,
      _1486: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1487: o => o instanceof Int8Array,
      _1488: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1489: o => o instanceof Uint8ClampedArray,
      _1490: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1491: o => o instanceof Uint16Array,
      _1492: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1493: o => o instanceof Int16Array,
      _1494: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1495: o => o instanceof Uint32Array,
      _1496: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1497: o => o instanceof Int32Array,
      _1498: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1500: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1501: o => o instanceof Float32Array,
      _1502: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1503: o => o instanceof Float64Array,
      _1504: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1505: (t, s) => t.set(s),
      _1506: l => new DataView(new ArrayBuffer(l)),
      _1507: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1508: o => o.byteLength,
      _1509: o => o.buffer,
      _1510: o => o.byteOffset,
      _1511: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1512: (b, o) => new DataView(b, o),
      _1513: (b, o, l) => new DataView(b, o, l),
      _1514: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1515: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1516: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1517: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1518: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1519: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1520: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1521: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1522: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1523: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1524: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1525: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1528: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1529: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1530: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1531: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1532: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1533: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1546: (ms, c) =>
      ...
      _1558: x0 => x0.send(),
      _1559: (x0,x1) => new WebSocket(x0,x1),
      _1560: (x0,x1) => x0.getResponseHeader(x1),
      _1566: (x0,x1) => x0.item(x1),
      ...
      _1755: x0 => x0.readyState,
      _1757: (x0,x1) => { x0.timeout = x1 },
      _1759: (x0,x1) => { x0.withCredentials = x1 },
      _1760: x0 => x0.upload,
      _1761: x0 => x0.responseURL,
      _1762: x0 => x0.status,
      _1763: x0 => x0.statusText,
      _1765: (x0,x1) => { x0.responseType = x1 },
      _1766: x0 => x0.response,
      _1767: x0 => x0.responseText,
      _1778: x0 => x0.loaded,
      _1779: x0 => x0.total,
      _1842: x0 => x0.style,
      _2414: x0 => x0.videoWidth,
      _2415: x0 => x0.videoHeight,
      _2419: (x0,x1) => { x0.playsInline = x1 },
      _2445: x0 => x0.error,
      _2447: (x0,x1) => { x0.src = x1 },
      _2452: (x0,x1) => { x0.crossOrigin = x1 },
      _2455: (x0,x1) => { x0.preload = x1 },
      _2456: x0 => x0.buffered,
      _2459: x0 => x0.currentTime,
      _2460: (x0,x1) => { x0.currentTime = x1 },
      _2461: x0 => x0.duration,
      _2466: (x0,x1) => { x0.playbackRate = x1 },
      _2473: (x0,x1) => { x0.autoplay = x1 },
      _2475: (x0,x1) => { x0.loop = x1 },
      _2477: (x0,x1) => { x0.controls = x1 },
      _2479: (x0,x1) => { x0.volume = x1 },
      _2481: (x0,x1) => { x0.muted = x1 },
      _2496: x0 => x0.code,
      _2497: x0 => x0.message,
      _2570: x0 => x0.length,
      ...
      _3080: (x0,x1) => { x0.async = x1 },
      _3094: (x0,x1) => { x0.charset = x1 },
      _3538: () => globalThis.window,
      _3581: x0 => x0.location,
      _3600: x0 => x0.navigator,
      _3864: x0 => x0.localStorage,
      _3875: x0 => x0.protocol,
      _3879: x0 => x0.hostname,
      _3881: x0 => x0.port,
      _3968: x0 => x0.geolocation,
      _3971: x0 => x0.mediaDevices,
      _3973: x0 => x0.permissions,
      _3974: x0 => x0.maxTouchPoints,
      _3984: x0 => x0.platform,
      _3987: x0 => x0.userAgent,
      _4038: x0 => x0.data,
      _4195: x0 => x0.length,
      _4424: x0 => x0.binaryType,
      _4425: (x0,x1) => { x0.binaryType = x1 },
      _5580: x0 => x0.destination,
      _6135: x0 => x0.signal,
      _6147: x0 => x0.length,
      ...
      _8671: x0 => x0.headers,
      _8672: x0 => x0.body,
      _10795: (x0,x1) => { x0.border = x1 },
      _11237: (x0,x1) => { x0.height = x1 },
      _11927: (x0,x1) => { x0.width = x1 },
      _12295: x0 => x0.name,
      _12296: x0 => x0.message,
