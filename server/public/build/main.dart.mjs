...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1267: (x0,x1) => x0.canShare(x1),
      _1268: (x0,x1) => x0.share(x1),
      _1271: (x0,x1) => ({files: x0,text: x1}),
      _1273: x0 => ({files: x0}),
      _1275: x0 => ({text: x0}),
      _1276: x0 => x0.click(),
      _1277: x0 => x0.remove(),
      ...
      _1294: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1296: x0 => x0.load(),
      _1297: x0 => x0.play(),
      _1298: x0 => x0.pause(),
      ...
      _1317: (x0,x1) => x0.send(x1),
      _1318: x0 => x0.abort(),
      _1319: x0 => x0.getAllResponseHeaders(),
      _1322: x0 => x0.close(),
      _1323: x0 => new WebSocket(x0),
      _1324: (x0,x1) => x0.send(x1),
      _1325: x0 => x0.decode(),
      _1326: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1327: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1330: x0 => x0.send(),
      _1331: () => new XMLHttpRequest(),
      _1335: () => new AudioContext(),
      _1336: (x0,x1) => x0.createMediaElementSource(x1),
      _1337: x0 => x0.createStereoPanner(),
      _1338: (x0,x1) => x0.connect(x1),
      _1339: (x0,x1) => x0.getItem(x1),
      _1340: (x0,x1) => x0.removeItem(x1),
      _1341: (x0,x1,x2) => x0.setItem(x1,x2),
      _1417: (x0,x1) => x0.appendChild(x1),
