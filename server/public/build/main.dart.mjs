...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1282: (x0,x1) => x0.canShare(x1),
      _1283: (x0,x1) => x0.share(x1),
      _1285: (x0,x1,x2) => ({files: x0,title: x1,text: x2}),
      _1286: (x0,x1) => ({files: x0,text: x1}),
      _1287: (x0,x1) => ({files: x0,title: x1}),
      _1288: x0 => ({files: x0}),
      _1289: (x0,x1) => ({title: x0,text: x1}),
      _1292: x0 => x0.remove(),
      _1295: x0 => x0.createRange(),
      _1296: (x0,x1) => x0.selectNode(x1),
      _1297: x0 => x0.getSelection(),
      _1298: x0 => x0.removeAllRanges(),
      _1299: (x0,x1) => x0.addRange(x1),
      _1300: (x0,x1) => x0.createElement(x1),
      _1301: (x0,x1) => x0.append(x1),
      _1302: (x0,x1,x2) => x0.insertRule(x1,x2),
      _1303: (x0,x1) => x0.add(x1),
      ...
      _1309: x0 => x0.play(),
      _1310: x0 => x0.pause(),
      _1312: (x0,x1) => x0.removeAttribute(x1),
      _1314: (x0,x1) => x0.start(x1),
      _1315: (x0,x1) => x0.end(x1),
      ...
      _1324: () => new XMLHttpRequest(),
      _1325: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1326: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1327: (x0,x1) => x0.send(x1),
      _1328: x0 => x0.abort(),
      _1329: x0 => x0.getAllResponseHeaders(),
      _1332: x0 => x0.close(),
      _1333: x0 => new WebSocket(x0),
      _1334: (x0,x1) => x0.send(x1),
      _1335: x0 => x0.decode(),
      ...
      _1342: x0 => globalThis.Wakelock.toggle(x0),
      _1344: () => new AudioContext(),
      _1345: (x0,x1) => x0.createMediaElementSource(x1),
      _1346: x0 => x0.createStereoPanner(),
      _1347: (x0,x1) => x0.connect(x1),
      _1348: (x0,x1) => x0.getItem(x1),
      _1349: (x0,x1) => x0.removeItem(x1),
      _1350: (x0,x1,x2) => x0.setItem(x1,x2),
      _1427: () => globalThis.removeSplashFromWeb(),
      _1429: Date.now,
      ...
      _1467: Object.is,
      _1468: o => o instanceof Array,
      _1469: (a, i) => a.push(i),
      _1470: (a, i) => a.splice(i, 1)[0],
      _1472: (a, l) => a.length = l,
      _1473: a => a.pop(),
      _1474: (a, i) => a.splice(i, 1),
      _1475: (a, s) => a.join(s),
      _1476: (a, s, e) => a.slice(s, e),
      _1478: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1479: a => a.length,
      ...
      _1485: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1487: o => o instanceof Uint8Array,
      _1488: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1489: o => o instanceof Int8Array,
      _1490: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1491: o => o instanceof Uint8ClampedArray,
      _1492: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1493: o => o instanceof Uint16Array,
      _1494: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1495: o => o instanceof Int16Array,
      _1496: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1497: o => o instanceof Uint32Array,
      _1498: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1499: o => o instanceof Int32Array,
      _1500: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1502: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1503: o => o instanceof Float32Array,
      _1504: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1505: o => o instanceof Float64Array,
      _1506: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1507: (t, s) => t.set(s),
      _1508: l => new DataView(new ArrayBuffer(l)),
      _1509: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1510: o => o.byteLength,
      _1511: o => o.buffer,
      _1512: o => o.byteOffset,
      _1513: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1514: (b, o) => new DataView(b, o),
      _1515: (b, o, l) => new DataView(b, o, l),
      _1516: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1517: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1518: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1519: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1520: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1521: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1522: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1523: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1524: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1525: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1526: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1527: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1530: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1531: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1532: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1533: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1534: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1535: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1548: (ms, c) =>
      ...
      _1562: (x0,x1) => x0.getResponseHeader(x1),
      _1567: (x0,x1) => x0.item(x1),
      ...
      _1675: () => globalThis.window,
      _1680: (x0,x1) => { x0.height = x1 },
      _1682: (x0,x1) => { x0.width = x1 },
      _1685: x0 => x0.head,
      _1686: x0 => x0.classList,
      _1690: (x0,x1) => { x0.innerText = x1 },
      _1691: x0 => x0.style,
      _1693: x0 => x0.sheet,
      _1694: x0 => x0.src,
      ...
      _1840: x0 => x0.style,
      _2093: x0 => x0.content,
      _2412: x0 => x0.videoWidth,
      _2413: x0 => x0.videoHeight,
      _2417: (x0,x1) => { x0.playsInline = x1 },
      _2443: x0 => x0.error,
      _2445: (x0,x1) => { x0.src = x1 },
      _2450: (x0,x1) => { x0.crossOrigin = x1 },
      _2453: (x0,x1) => { x0.preload = x1 },
      _2454: x0 => x0.buffered,
      _2457: x0 => x0.currentTime,
      _2458: (x0,x1) => { x0.currentTime = x1 },
      _2459: x0 => x0.duration,
      _2464: (x0,x1) => { x0.playbackRate = x1 },
      _2471: (x0,x1) => { x0.autoplay = x1 },
      _2473: (x0,x1) => { x0.loop = x1 },
      _2475: (x0,x1) => { x0.controls = x1 },
      _2477: (x0,x1) => { x0.volume = x1 },
      _2479: (x0,x1) => { x0.muted = x1 },
      _2494: x0 => x0.code,
      _2495: x0 => x0.message,
      _2568: x0 => x0.length,
      _3071: x0 => x0.src,
      _3072: (x0,x1) => { x0.src = x1 },
      _3074: (x0,x1) => { x0.type = x1 },
      _3078: (x0,x1) => { x0.async = x1 },
      _3092: (x0,x1) => { x0.charset = x1 },
      _3541: () => globalThis.window,
      _3584: x0 => x0.location,
      _3603: x0 => x0.navigator,
      _3867: x0 => x0.localStorage,
      _3875: x0 => x0.href,
      _3878: x0 => x0.protocol,
      _3882: x0 => x0.hostname,
      _3884: x0 => x0.port,
      _3969: x0 => x0.clipboard,
      _3971: x0 => x0.geolocation,
      _3974: x0 => x0.mediaDevices,
      _3976: x0 => x0.permissions,
      _3977: x0 => x0.maxTouchPoints,
      _3987: x0 => x0.platform,
      _3990: x0 => x0.userAgent,
      _4041: x0 => x0.data,
      _4198: x0 => x0.length,
      _4427: x0 => x0.binaryType,
      _4428: (x0,x1) => { x0.binaryType = x1 },
      _5583: x0 => x0.destination,
      _6138: x0 => x0.signal,
      _6150: x0 => x0.length,
